const {lorem} = require('../../credentials.json')
...
describe('Open page', () => {
	const environment = environmentEnum.LOCAL
	const {path, username, userPath} = Cypress.env( environment )
	...
	// })
	//
	// it('Create workout and completed it', () => {
	//     cy.contains( 'Create a Plan' ).click()
	//     cy.contains( 'OK' ).click()
